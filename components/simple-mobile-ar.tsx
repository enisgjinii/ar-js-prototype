        ...
        try {
            ...
            const handleTap = () => {
                ...
                const sphereMaterial = new THREE.MeshBasicMaterial({
                    color: new (THREE as any).Color(Math.random(), Math.random(), Math.random())
                });
            ...
            {!isARActive && !isLoading && !error && (
                <div className="absolute inset-0 flex items-center justify-center z-20">
                    <div className="text-center">
                        ...
                        <p className="text-white text-sm mt-2">Basic AR - No surface detection needed</p>
                    </div>
                </div>
            )}
            ...
            {isLoading && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/80 z-20">
                    <div className="text-center text-white">
                        ...
                        <p className="text-sm opacity-70">No complex features, just basics</p>
                    </div>
                </div>
            )}
