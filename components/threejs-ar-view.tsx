...
export default function ThreeJSARView({ onBack }: ThreeJSARViewProps) {
    ...
    const startThreeJSAR = async () => {
        ...
        try {
            ...
            if (!supported) {
                throw new Error('AR not supported. Install Google Play Services for AR from Play Store.');
            }
            ...
            {!isARActive && !isLoading && !error && (
                <div className="absolute inset-0 flex items-center justify-center z-20">
                    <div className="text-center">
                        ...
                        <p className="text-white text-sm mt-2">Professional AR with Three.js + WebXR</p>
                    </div>
                </div>
            )}
