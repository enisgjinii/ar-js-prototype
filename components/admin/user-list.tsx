...
export function UserList({ users: initialUsers }: { users: User[] }) {
    ...
    const getProviderDisplay = (provider: string) => {
        ...
        return providers[provider] || { name: provider, icon: '🔑', color: 'bg-gray-100 text-gray-700' }
    }

    const exportUsers = () => {
        const csv = [
            ['Name', 'Email', 'Status', 'Provider', 'Created', 'Last Sign In', 'Role'].join(','),
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs text-gray-500">
                                                ...
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="capitalize">{user.profile?.role || 'user'}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="mt-3">
                                                {(() => {
                                                    ...
                                                    return (
                                                        <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${providerInfo.color}`}>
