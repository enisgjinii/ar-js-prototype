...
export default async function UsersPage() {
                            ...
                            <div>
                                ...
                                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-left max-w-2xl mx-auto">
                                    ...
                                    <ol className="text-sm text-gray-700 space-y-2 list-decimal list-inside">
                                        ...
                                        <li>Add it to your <code className="bg-gray-200 px-1 rounded">.env.local</code> file:</li>
                                    </ol>
                                ...
                                <p className="text-xs text-gray-500 mt-4">
                                    ⚠️ Keep the service role key secret - never expose it to the client!
                                </p>
                            </div>
                        </div>
                    </CardContent>
    ...
    const verifiedUsers = usersWithProfiles.filter(u => u.email_confirmed_at).length
