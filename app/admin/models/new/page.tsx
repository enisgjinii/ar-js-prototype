    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (errorMessage.includes('not found') || errorMessage.includes('does not exist')) {
                toast.error('Storage bucket not found. Please create the "models" bucket in Supabase Storage.')
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-500">Add a new GLB or GLTF model to your collection</p>
                </div>
            </div>
