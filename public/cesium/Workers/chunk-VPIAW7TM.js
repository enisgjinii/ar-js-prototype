...
import { c as Z } from './chunk-KWW52NRT.js';
import { a as o, b as at, e as b } from './chunk-HMXGNDLA.js';
import { a as R } from './chunk-V7XA5C77.js';
import { a as w, b as tt } from './chunk-U7V5VQ2T.js';
import { e as g } from './chunk-NVZ5L4JK.js';
var et = {};
et.computeDiscriminant = function (t, e, r) {
...
et.computeRealRoots = function (t, e, r) {
  if (typeof t != 'number') throw new w('a is a required number.');
  if (typeof e != 'number') throw new w('b is a required number.');
  if (typeof r != 'number') throw new w('c is a required number.');
  let n;
  ...
  let i = e * e,
    c = 4 * t * r,
    s = ft(i, -c, R.EPSILON14);
  if (s < 0) return [];
  let u = -0.5 * ft(e, R.sign(e) * Math.sqrt(s), R.EPSILON14);
  return e > 0 ? [u / t, r / u] : [r / u, u / t];
};
var T = et;
var rt = {};
rt.computeDiscriminant = function (t, e, r, n) {
  if (typeof t != 'number') throw new w('a is a required number.');
  if (typeof e != 'number') throw new w('b is a required number.');
  if (typeof r != 'number') throw new w('c is a required number.');
...
function nt(t, e, r, n) {
  ...
  if (h < 0) {
    ...
    l * f >= a * m
      ? ((K = i), (k = p), (G = -2 * c * p + i * q))
      : ((K = u), (k = d), (G = -u * q + 2 * s * d));
    let ut = -(G < 0 ? -1 : 1) * Math.abs(K) * Math.sqrt(-h);
    D = -G + ut;
    let X = D / 2,
      j = X < 0 ? -Math.pow(-X, 1 / 3) : Math.pow(X, 1 / 3),
      $ = D === ut ? -j : -k / j;
    return (
      (E = k <= 0 ? j + $ : -G / (j * j + $ * $ + k)),
      l * f >= a * m ? [(E - c) / i] : [-u / (E + s)]
...
rt.computeRealRoots = function (t, e, r, n) {
  if (typeof t != 'number') throw new w('a is a required number.');
  if (typeof e != 'number') throw new w('b is a required number.');
  if (typeof r != 'number') throw new w('c is a required number.');
  if (typeof n != 'number') throw new w('d is a required number.');
...
var Y = rt;
var ot = {};
ot.computeDiscriminant = function (t, e, r, n, i) {
  if (typeof t != 'number') throw new w('a is a required number.');
  if (typeof e != 'number') throw new w('b is a required number.');
  if (typeof r != 'number') throw new w('c is a required number.');
  if (typeof n != 'number') throw new w('d is a required number.');
...
function z(t, e, r, n) {
  let i = t * t,
    ...
    a = Y.computeRealRoots(1, 2 * c, c * c - 4 * u, -s * s);
  if (a.length > 0) {
    let f = -t / 4,
      l = a[a.length - 1];
    if (Math.abs(l) < R.EPSILON14) {
      let m = T.computeRealRoots(1, c, u);
      if (m.length === 2) {
        let p = m[0],
          q = m[1],
          d;
        if (p >= 0 && q >= 0) {
          ...
          if (p >= 0 && q < 0) return ((d = Math.sqrt(p)), [f - d, f + d]);
          if (p < 0 && q >= 0) return ((d = Math.sqrt(q)), [f - d, f + d]);
        }
      }
      return [];
    } else if (l > 0) {
      let m = Math.sqrt(l),
        p = (c + l - s / m) / 2,
        q = (c + l + s / m) / 2,
        d = T.computeRealRoots(1, m, p),
        h = T.computeRealRoots(1, -m, q);
      return d.length !== 0
        ? ((d[0] += f),
          (d[1] += f),
          h.length !== 0
...
ot.computeRealRoots = function (t, e, r, n, i) {
  if (typeof t != 'number') throw new w('a is a required number.');
  if (typeof e != 'number') throw new w('b is a required number.');
  if (typeof r != 'number') throw new w('c is a required number.');
  if (typeof n != 'number') throw new w('d is a required number.');
  if (typeof i != 'number') throw new w('e is a required number.');
  if (Math.abs(t) < R.EPSILON15) return Y.computeRealRoots(e, r, n, i);
  let c = e / t,
    s = r / t,
    u = n / t,
    a = i / t,
...
F.getPoint = function (t, e, r) {
  return (
    tt.typeOf.object('ray', t),
    tt.typeOf.number('t', e),
    g(r) || (r = new o()),
...
O.rayTriangleParametric = function (t, e, r, n, i) {
  ...
  if (i) {
    if (
      l < R.EPSILON6 ||
      ((m = o.subtract(c, e, mt)), (q = o.dot(m, f)), q < 0 || q > l) ||
      ((p = o.cross(m, u, lt)), (d = o.dot(s, p)), d < 0 || q + d > l)
    )
      return;
    h = o.dot(a, p) / l;
  } else {
    ...
    if (
      ...
      q < 0 ||
        q > 1 ||
        ((p = o.cross(m, u, lt)), (d = o.dot(s, p) * E), d < 0 || q + d > 1))
    )
      return;
    h = o.dot(a, p) * E;
  }
...
function Mt(t, e, r) {
  ...
  let n = t.origin,
    ...
    m = Et(a, f, l, Ct);
  if (g(m)) return ((r.start = m.root0), (r.stop = m.root1), r);
}
O.raySphere = function (t, e, r) {
  if (!g(t)) throw new w('ray is required.');
  if (!g(e)) throw new w('sphere is required.');
  if (((r = Mt(t, e, r)), !(!g(r) || r.stop < 0)))
...
O.rayEllipsoid = function (t, e) {
  ...
  let r = e.oneOverRadii,
    n = o.multiplyComponents(r, t.origin, Lt),
    i = o.multiplyComponents(r, t.direction, It),
  ...
  if (c > 1) {
    ...
    if (p > f) {
      ((l = s * s - f), (m = -s + Math.sqrt(l)));
      let d = m / a,
        h = u / m;
      return d < h ? new Z(d, h) : { start: h, stop: d };
    }
    let q = Math.sqrt(u / a);
    return new Z(q, q);
  } else if (c < 1)
...
O.quadraticVectorExpression = function (t, e, r, n, i) {
  let c = n * n,
    ...
    m = i * (n * Q(t[b.COLUMN2ROW0], t[b.COLUMN0ROW2]) + e.z),
    p,
    q = [];
  if (m === 0 && l === 0) {
...
O.grazingAltitudeLocation = function (t, e) {
  ...
  if (!o.equals(r, o.ZERO)) {
    let I = e.geodeticSurfaceNormal(r, st);
    if (o.dot(n, I) >= 0) return r;
  }
  let i = g(this.rayEllipsoid(t, e)),
    c = e.transformPositionToScaledSpace(n, st),
    s = o.normalize(c, c),
    u = o.mostOrthogonalAxis(c, J),
    a = o.normalize(o.cross(u, s, ht), ht),
    f = o.normalize(o.cross(s, a, wt), wt),
    l = Bt;
  ((l[0] = s.x),
    (l[1] = s.y),
    (l[2] = s.z),
    ...
    (l[7] = f.y),
    (l[8] = f.z));
  let m = b.transpose(l, xt),
    p = b.fromScale(e.radii, Tt),
    q = b.fromScale(e.oneOverRadii, zt),
    d = Wt;
  ((d[0] = 0),
    (d[1] = -n.z),
    (d[2] = n.y),
    ...
    (d[7] = n.x),
    (d[8] = 0));
  let h = b.multiply(b.multiply(m, q, qt), d, qt),
    E = b.multiply(b.multiply(h, p, gt), l, gt),
    D = b.multiplyByVector(h, r, Dt),
    W = O.quadraticVectorExpression(E, o.negate(D, st), 0, 0, 1),
    v,
    L,
    B = W.length;
  if (B > 0) {
    ...
    for (let y = 0; y < B; ++y) {
      v = b.multiplyByVector(p, b.multiplyByVector(l, W[y], pt), pt);
      let S = o.normalize(o.subtract(v, r, J), J),
        M = o.dot(S, n);
    ...
    return (
      (C = R.clamp(C, 0, 1)),
      (L = o.magnitude(o.subtract(I, r, J)) * Math.sqrt(1 - C * C)),
      (L = i ? -L : L),
      (P.height = L),
...
O.trianglePlaneIntersection = function (t, e, r, n) {
  ...
  let l, m;
  if (((f === 1 || f === 2) && ((l = new o()), (m = new o())), f === 1)) {
    if (s)
      return (
        O.lineSegmentPlane(t, e, n, l),
        O.lineSegmentPlane(t, r, n, m),
        { positions: [t, e, r, l, m], indices: [0, 3, 4, 1, 2, 4, 1, 4, 3] }
      );
    if (u)
      return (
        O.lineSegmentPlane(e, r, n, l),
        O.lineSegmentPlane(e, t, n, m),
        { positions: [t, e, r, l, m], indices: [1, 3, 4, 2, 0, 4, 2, 4, 3] }
      );
    if (a)
      return (
        O.lineSegmentPlane(r, t, n, l),
        O.lineSegmentPlane(r, e, n, m),
        { positions: [t, e, r, l, m], indices: [2, 3, 4, 0, 1, 4, 0, 4, 3] }
      );
  } else if (f === 2)
    if (s)
      if (u) {
        if (!a)
          return (
            ...
            O.lineSegmentPlane(e, r, n, m),
            { positions: [t, e, r, l, m], indices: [0, 1, 4, 0, 4, 3, 2, 3, 4] }
          );
      } else
        return (
          O.lineSegmentPlane(r, e, n, l),
          O.lineSegmentPlane(t, e, n, m),
          { positions: [t, e, r, l, m], indices: [2, 0, 4, 2, 4, 3, 1, 3, 4] }
        );
    else
      return (
        O.lineSegmentPlane(e, t, n, l),
        O.lineSegmentPlane(r, t, n, m),
        { positions: [t, e, r, l, m], indices: [1, 2, 4, 1, 4, 3, 0, 3, 4] }
      );
};
var me = O;
export { it as a, me as b };
