...
import { b as Z, h as A } from './chunk-S2E5UWT4.js';
import { a as n, b as v, d as N, e as _ } from './chunk-HMXGNDLA.js';
import { a as on } from './chunk-V7XA5C77.js';
import { a as en, b as h } from './chunk-U7V5VQ2T.js';
import { e as x } from './chunk-NVZ5L4JK.js';
function I(e) {
...
I.prototype.project = function (e, t) {
...
I.prototype.unproject = function (e, t) {
...
var k = I;
var sn = { OUTSIDE: -1, INTERSECTING: 0, INSIDE: 1 },
  U = Object.freeze(sn);
function mn(e, t) {
...
a.fromPoints = function (e, t) {
  ...
  let u = n.magnitudeSquared(n.subtract(f, c, b)),
    ...
    B = n.magnitudeSquared(n.subtract(m, d, b)),
    T = c,
    q = f,
    O = u;
  (i > O && ((O = i), (T = r), (q = s)), B > O && ((O = B), (T = d), (q = m)));
  let p = L;
  ((p.x = (T.x + q.x) * 0.5),
    (p.y = (T.y + q.y) * 0.5),
    (p.z = (T.z + q.z) * 0.5));
  ...
  let E = n.midpoint(j, P, tn),
    D = 0;
  for (y = 0; y < z; y++) {
    n.clone(e[y], o);
    let C = n.magnitude(n.subtract(o, E, b));
    C > D && (D = C);
...
a.fromVertices = function (e, t, o, c) {
  ...
  let B = n.magnitudeSquared(n.subtract(m, d, b)),
    T = n.magnitudeSquared(n.subtract(z, f, b)),
    q = n.magnitudeSquared(n.subtract(y, s, b)),
    O = d,
    p = m,
    S = B;
  (T > S && ((S = T), (O = f), (p = z)), q > S && ((S = q), (O = s), (p = y)));
  let l = L;
  ((l.x = (O.x + p.x) * 0.5),
    (l.y = (O.y + p.y) * 0.5),
    (l.z = (O.z + p.z) * 0.5));
  let j = n.magnitudeSquared(n.subtract(p, l, b)),
    P = Math.sqrt(j),
    E = H;
  ((E.x = d.x), (E.y = f.y), (E.z = s.z));
  let D = nn;
  ((D.x = m.x), (D.y = z.y), (D.z = y.z));
  let C = n.midpoint(E, D, tn),
    M = 0;
  for (i = 0; i < u; i += o) {
    ((r.x = e[i] + t.x), (r.y = e[i + 1] + t.y), (r.z = e[i + 2] + t.z));
    let w = n.magnitude(n.subtract(r, C, b));
    w > M && (M = w);
...
a.fromEncodedCartesianVertices = function (e, t, o) {
  ...
  let i = n.magnitudeSquared(n.subtract(s, r, b)),
    ...
    O = s,
    p = i;
  (B > p && ((p = B), (q = d), (O = m)), T > p && ((p = T), (q = f), (O = z)));
  let S = L;
  ((S.x = (q.x + O.x) * 0.5),
    (S.y = (q.y + O.y) * 0.5),
    (S.z = (q.z + O.z) * 0.5));
  ...
  let E = nn;
  ((E.x = s.x), (E.y = m.y), (E.z = z.z));
  let D = n.midpoint(P, E, tn),
    C = 0;
  for (u = 0; u < y; u += 3) {
    ((c.x = e[u] + t[u]),
      (c.y = e[u + 1] + t[u + 1]),
...
a.fromBoundingSpheres = function (e, t) {
  ...
  for (r = 0; r < o; r++) {
    let s = e[r];
    f = Math.max(f, n.distance(d, s.center, pn) + s.radius);
  }
  return ((t.radius = f), t);
};
var hn = new n(),
...
a.fromOrientedBoundingBox = function (e, t) {
  ...
  let o = e.halfAxes,
    c = _.getColumn(o, 0, hn),
    r = _.getColumn(o, 1, zn),
    d = _.getColumn(o, 2, Sn);
  return (
    n.add(c, r, c),
    n.add(c, d, c),
...
a.union = function (e, t, o) {
  ...
  let z = (r + m + f) * 0.5,
    y = n.multiplyByScalar(s, (-r + z) / m, On);
...
a.expand = function (e, t, o) {
  (h.typeOf.object('sphere', e),
    ...
    (o = a.clone(e, o)));
  let c = n.magnitude(n.subtract(t, o.center, jn));
...
a.distanceSquaredTo = function (e, t) {
  ...
  let o = n.subtract(e.center, t, bn),
...
a.computePlaneDistances = function (e, t, o, c) {
  (h.typeOf.object('sphere', e),
    ...
    x(c) || (c = new cn()));
  let r = n.subtract(e.center, t, qn),
    d = n.dot(o, r);
...
a.projectTo2D = function (e, t, o) {
  ...
  let s = n.cross(n.UNIT_Z, f, Mn);
  n.normalize(s, s);
  let m = n.cross(f, s, Tn);
  (n.normalize(m, m),
  ...
  for (let p = 0; p < B; ++p) {
    let S = u[p];
    n.add(r, S, S);
    let l = c.cartesianToCartographic(S, En);
    t.project(l, S);
  }
...
var Ln = a;
export { k as a, U as b, cn as c, Ln as d };
