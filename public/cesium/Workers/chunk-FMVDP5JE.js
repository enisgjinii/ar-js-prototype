...
import { a as y } from './chunk-HICISBVP.js';
import { d as L } from './chunk-KWW52NRT.js';
import { b as d, h as W } from './chunk-S2E5UWT4.js';
import { a as A } from './chunk-XNSUDY5I.js';
import { a as s, b as k, c as T, d as b } from './chunk-HMXGNDLA.js';
import { a as E } from './chunk-V7XA5C77.js';
import { a as I, b as z } from './chunk-U7V5VQ2T.js';
import { e as h } from './chunk-NVZ5L4JK.js';
function x(o, t) {
...
x.prototype.isPointVisible = function (o) {
  let e = this._ellipsoid.transformPositionToScaledSpace(o, j);
  return D(
    e,
    this._cameraPositionInScaledSpace,
...
x.prototype.computeHorizonCullingPoint = function (o, t, e) {
  return Z(this._ellipsoid, o, t, e);
};
var U = b.clone(b.UNIT_SPHERE);
x.prototype.computeHorizonCullingPointPossiblyUnderEllipsoid = function (
  ...
  let i = v(this._ellipsoid, e, U);
  return Z(i, o, t, n);
};
x.prototype.computeHorizonCullingPointFromVertices = function (o, t, e, n, i) {
  return Q(this._ellipsoid, o, t, e, n, i);
};
x.prototype.computeHorizonCullingPointFromVerticesPossiblyUnderEllipsoid =
  function (o, t, e, n, i, c) {
    let a = v(this._ellipsoid, i, U);
    return Q(a, o, t, e, n, c);
  };
var nt = [];
x.prototype.computeHorizonCullingPointFromRectangle = function (o, t, e) {
  z.typeOf.object('rectangle', o);
  let n = W.subsample(o, t, 0, nt),
    i = L.fromPoints(n);
  if (!(s.magnitude(i.center) < 0.1 * t.minimumRadius))
    return this.computeHorizonCullingPoint(i.center, n, e);
};
var at = new s();
function v(o, t, e) {
  if (h(t) && t < 0 && o.minimumRadius > -t) {
    let n = s.fromElements(o.radii.x + t, o.radii.y + t, o.radii.z + t, at);
    o = b.fromCartesian3(n, e);
  }
  return o;
}
function Z(o, t, e, n) {
...
var q = new s();
function Q(o, t, e, n, i, c) {
  (z.typeOf.object('directionToPoint', t),
    z.defined('vertices', e),
    z.typeOf.number('stride', n),
    h(c) || (c = new s()),
    (n = n ?? 3),
    (i = i ?? s.ZERO));
  let a = X(o, t),
    r = 0;
  for (let m = 0, l = e.length; m < l; m += n) {
    ((q.x = e[m] + i.x), (q.y = e[m + 1] + i.y), (q.z = e[m + 2] + i.z));
    let u = J(o, q, a);
    if (u < 0) return;
    r = Math.max(r, u);
  }
...
var st = new s(),
  ct = new s();
function J(o, t, e) {
  let n = o.transformPositionToScaledSpace(t, st),
    i = s.magnitudeSquared(n),
    c = Math.sqrt(i),
    a = s.divideByScalar(n, c, ct);
  ((i = Math.max(1, i)), (c = Math.max(1, c)));
  let r = s.dot(a, e),
    m = s.magnitude(s.cross(a, e, a)),
    l = 1 / c,
    u = Math.sqrt(i - 1) * l;
  return 1 / (r * l - m * u);
}
...
function X(o, t) {
  return s.equals(t, s.ZERO)
    ? t
    : (o.transformPositionToScaledSpace(t, R), s.normalize(R, R));
}
var Tt = x;
var M = {};
M.getHeight = function (o, t, e) {
...
var rt = new k();
M.getPosition = function (o, t, e, n, i) {
  let c = t.cartesianToCartographic(o, rt);
  if (!h(c)) return s.clone(o, i);
  let a = M.getHeight(c.height, e, n);
  return s.fromRadians(c.longitude, c.latitude, a, t, i);
};
var Y = M;
var mt = { NONE: 0, BITS12: 1 },
  S = Object.freeze(mt);
var _ = new s(),
  dt = new s(),
  f = new T(),
  ...
  ht = new d(),
  lt = Math.pow(2, 12);
function p(o, t, e, n, i, c, a, r, m, l) {
  let u = S.NONE,
    g,
    N;
  if (h(t) && h(e) && h(n) && h(i)) {
    let C = t.minimum,
      ...
      P = s.subtract(V, C, dt),
      B = n - e;
    (Math.max(s.maximumComponent(P), B) < lt - 1
      ? (u = S.BITS12)
      : (u = S.NONE),
      (g = d.inverseTransformation(i, new d())));
    let tt = s.negate(C, _);
    d.multiply(d.fromTranslation(tt, O), g, g);
    let w = _;
    ((w.x = 1 / P.x),
      (w.y = 1 / P.y),
      (w.z = 1 / P.z),
      d.multiply(d.fromScale(w, O), g, g),
      (N = d.clone(i)),
      d.setTranslation(N, s.ZERO, N),
      (i = d.clone(i, new d())));
    let ot = d.fromTranslation(C, O),
      et = d.fromScale(P, ht),
      F = d.multiply(ot, et, O);
    (d.multiply(i, F, i), d.multiply(N, F, N));
  }
  ((this.quantization = u),
    ...
    (this.hasGeodeticSurfaceNormals = r ?? !1),
    (this.exaggeration = m ?? 1),
    (this.exaggerationRelativeHeight = l ?? 0),
    (this.stride = 0),
    (this._offsetGeodeticSurfaceNormal = 0),
    (this._offsetVertexNormal = 0),
    this._calculateStrideAndOffsets());
}
p.prototype.encode = function (o, t, e, n, i, c, a, r) {
  let m = n.x,
    l = n.y;
  if (this.quantization === S.BITS12) {
    ((e = d.multiplyByPoint(this.toScaledENU, e, _)),
      (e.x = E.clamp(e.x, 0, 1)),
      (e.y = E.clamp(e.y, 0, 1)),
      (e.z = E.clamp(e.z, 0, 1)));
    let u = this.maximumHeight - this.minimumHeight,
      g = E.clamp((i - this.minimumHeight) / u, 0, 1);
    T.fromElements(e.x, e.y, f);
    let N = y.compressTextureCoordinates(f);
    T.fromElements(e.z, g, f);
    let C = y.compressTextureCoordinates(f);
    T.fromElements(m, l, f);
    let V = y.compressTextureCoordinates(f);
    if (((o[t++] = N), (o[t++] = C), (o[t++] = V), this.hasWebMercatorT)) {
      T.fromElements(a, 0, f);
      let P = y.compressTextureCoordinates(f);
      o[t++] = P;
    }
  } else
    (s.subtract(e, this.center, _),
      (o[t++] = _.x),
      (o[t++] = _.y),
      (o[t++] = _.z),
      (o[t++] = i),
...
p.prototype.addGeodeticSurfaceNormals = function (o, t, e) {
  ...
  for (let a = 0; a < i; a++) {
    ...
    let r = this.decodePosition(t, a, pt),
      m = e.geodeticSurfaceNormal(r, $),
      l = a * c + this._offsetGeodeticSurfaceNormal;
    ((t[l] = m.x), (t[l + 1] = m.y), (t[l + 2] = m.z));
  }
};
...
p.prototype.decodePosition = function (o, t, e) {
  if (
    (h(e) || (e = new s()), (t *= this.stride), this.quantization === S.BITS12)
  ) {
    let n = y.decompressTextureCoordinates(o[t], f);
    ((e.x = n.x), (e.y = n.y));
...
p.prototype.getExaggeratedPosition = function (o, t, e) {
  ...
  if (n !== 1 && this.hasGeodeticSurfaceNormals) {
    let a = this.decodeGeodeticSurfaceNormal(o, t, $),
      r = this.decodeHeight(o, t),
      m = Y.getHeight(r, n, i) - r;
    ((e.x += a.x * m), (e.y += a.y * m), (e.z += a.z * m));
  }
  return e;
};
...
p.prototype.getAttributes = function (o) {
  ...
  if (this.quantization === S.NONE) {
    a(G.position3DAndHeight, 4);
    let r = 2;
    ((r += this.hasWebMercatorT ? 1 : 0),
      (r += this.hasVertexNormals ? 1 : 0),
      a(G.textureCoordAndEncodedNormals, r),
      this.hasGeodeticSurfaceNormals && a(G.geodeticSurfaceNormal, 3));
  } else {
    let r = this.hasWebMercatorT || this.hasVertexNormals,
      m = this.hasWebMercatorT && this.hasVertexNormals;
    (a(H.compressed0, r ? 4 : 3),
      m && a(H.compressed1, 1),
      this.hasGeodeticSurfaceNormals && a(H.geodeticSurfaceNormal, 3));
  }
  return c;
};
