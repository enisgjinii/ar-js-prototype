...
import { f as g, g as j } from './chunk-HMXGNDLA.js';
import { a as i } from './chunk-V7XA5C77.js';
import { b as n } from './chunk-U7V5VQ2T.js';
...
e.prototype.toRgba = function () {
  return (
    (E[0] = e.floatToByte(this.red)),
    (E[1] = e.floatToByte(this.green)),
    (E[2] = e.floatToByte(this.blue)),
    (E[3] = e.floatToByte(this.alpha)),
    A[0]
  );
};
